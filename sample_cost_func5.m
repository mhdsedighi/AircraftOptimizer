function [ cost1,cost2] = sample_cost_func5(input)
global doplot
...
geo.dihed=     [input(1)*pi/180 0 0            %Dihedral of each partition of each wing    
                pi/5 0 0            %[rad]
                -pi/2 0 0];
...
geo.SW=         [input(2)*pi/180 0 0          %c/4 sweep of each partition. [rad]
                0 0 0
                0 0 0];
