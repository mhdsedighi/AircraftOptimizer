function fp_plot_plane5(body,geo,struc)
N=100;
mat=struc.XYZ;
% geo=struc.geo;
% [n,~]=size(mat);
...
sc=2;
plotvec( [0 0 0]',sc*[-1 0 0]','r')
plotvec( [0 0 0]',sc*[0 1 0]','g')
plotvec( [0 0 0]',sc*[0 0 -1]','b')
...
L=body.length(1);
fp_plot_body(L,facecolor,edgecolor)
...
trisurf(hullFacets,DT.Points(:,1),DT.Points(:,2),DT.Points(:,3),'FaceColor',facecolor,'EdgeColor',edgecolor,'FaceAlpha','0.3')
