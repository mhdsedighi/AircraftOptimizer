...
geo.dihed=     [0*pi/180 15*pi/180 0*pi/180            %Dihedral of each partition of each wing
    pi/6 0 0            %[rad]
    -pi/2 0 0];
...
% partno=2
[geo,lattice,struc,act]=part_rotation5(2,geo,lattice,results,struc,state,act,wingno,partno,Raxle_local,alpha,hinge_portion,ref);
