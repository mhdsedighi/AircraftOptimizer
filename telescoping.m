function [geo,lattice,struc,act]=telescoping(act_num,geo,ref,lattice,results,state,struc,act,wingno,partno,course_portion)
%%%%%%%%%%%%%%%%%%%%%%%
N_incements=3;
...
% 
% plotvec( rail_end,act_vec1*3,'r')
% plotvec( rail_end,act_vec2*3,'g')
% plotvec( rail_end,act_vec3*3,'b')
% hold on
...
if course_portion==1
    ...
    geo.b(wingno,partno)= geo.b(wingno,partno)*(1-0.99);
    geo.T(wingno,partno)=geo.T(wingno,partno)*(1-0.99);
