...
act_num=1;
% geo1=geo;
[geo,lattice,struc]=airfoil_bend(geo,lattice,struc,1,borderno,0.5,10);
% geo2=geo;
...
% bfrac1=0.5;
% b=54.76*0.3048;
% struc.geo.b(1,:)=[b*(1-bfrac1)/2 b*(1-bfrac1)/2 b*bfrac1];

% geo.SW=         [5 5 5          %c/4 sweep of each partition. [rad]
%     0 0 0]*pi/180;
...
% partno=2;
% [geo,lattice,struc,act]=part_rotation(1,geo,lattice,results,struc,state,act,wingno,partno,Raxle_local,alpha,hinge_portion,ref);
...
% figure
% hold on
% plot_plane(body,geo0,struc0)
% plot_plane(body,geo,struc)
% view(-70,22)
% 
% figure
% subplot(2,2,1)
% plot_plane_lokht(body,geo0,struc0)
% view(-90,0)
% subplot(2,2,2)
% plot_plane_lokht(body,geo0,struc0)
% view(0,0)
...
% figure
% subplot(2,2,1)
% plot_plane_lokht(body,geo,struc)
% view(-90,0)
% subplot(2,2,2)
% plot_plane_lokht(body,geo,struc)
% view(0,0)
