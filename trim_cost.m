function [cost] = trim_cost(input,finilize,geo,state,results,struc,act,engine,ref)
%%% trim
...
[geo,lattice,struc,act]=part_rotation(act_num,geo,lattice,results,struc,state,act,wingno,partno,Raxle_local,rot1,hinge_portion,ref);
