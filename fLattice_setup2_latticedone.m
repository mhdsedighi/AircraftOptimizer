function [lattice,ref]=fLattice_setup2_latticedone(geo,state,lattice,latticetype,ref)
...
%warning('off')
% [lattice,ref]=geosetup15(geo,ref);
...
function [lattice,ref]=geosetup15(geo,ref)
void=0;
try
    geo.meshtype;
catch
