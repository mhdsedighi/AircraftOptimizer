...
W_wing=2.5*ref.S_ref*10.7639*0.453592;
...
% 
[geo,lattice,struc,act]=telescoping8(1,geo,ref,lattice,results,state,struc,act,wingno,partno,course_portion)
% partno=2
% [geo,lattice,struc,act]=part_rotation5(1,geo,lattice,results,struc,state,act,wingno,partno,Raxle_local,alpha,hinge_portion,ref);
...
if doplot
%     fp_plot_plane(body,geo,struc)
end

fp_plot_plane5(body,geo,struc)
% [geo,lattice,struc,act]=telescoping8(1,geo,ref,lattice,results,state,struc,act,wingno,partno,-course_portion)
fp_plot_plane5(body,geo,struc)
