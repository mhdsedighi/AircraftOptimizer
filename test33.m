...
for i=1:nwing
    ...
    for j=1:npart
        ...
        k2=k1+geo.nx(i,j)-1;
        k2_f=k2+geo.fnx(i,j);
%         k3=k1+(geo.nx(i,j)+geo.fnx(i,j))*(geo.ny(i,j));
%         k4=k3+geo.nx(i,j)-1;
%         k4_f=k4+geo.fnx(i,j);
        
        plot3(mat(k1,1,1),mat(k1,1,2),mat(k1,1,3),'r*')
        plot3(mat(k2,2,1),mat(k2,2,2),mat(k2,2,3),'g*')
        plot3(mat(k1,3,1),mat(k1,3,2),mat(k1,3,3),'b*')
        plot3(mat(k2,4,1),mat(k2,4,2),mat(k2,4,3),'k*')
