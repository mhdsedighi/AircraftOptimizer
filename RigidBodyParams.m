function [RBP]=RigidBodyParams(TR)
% function [RBP,TR]=RigidBodyParams(TR)
% Compute exact rigid body parameters (see list below) of a solid object
% represented by a triangular surface mesh. For details, see the
% accompanying pdf titled "Rigid-body Parameters Using Divergence Theorem".
