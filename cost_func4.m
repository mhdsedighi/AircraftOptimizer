function cost_vec=cost_func4(input,N_condition,N_design,N_morph,N_trim,N_act,all_state,geo,all_struc,body,act,engine,ref,finilize)
...
cost_vec(1)=cost_trim;
cost_vec(2)=cost_st;
cost_vec(3)=mass_error;
