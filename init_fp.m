...
% geo.SW=         [7 7 40          %c/4 sweep of each partition. [rad]
%     0 0 0]*pi/180;
...
geo.nx=        [5 15 5           %Number of panels in the X direction of
        5 0 0];           %each partiton
...
% partno=2;
% [geo,lattice,struc,act]=part_rotation(2,geo,lattice,results,struc,state,act,wingno,partno,Raxle_local,deg2rad(-20),hinge_portion,ref);
