function[CD0]=zldpblunt(state,body,ref)
...
V=state.Mach*state.a;                          %Computing local TAS

% %% Friction coefficient
body.Re=(state.rho*V*body.length)./(state.mu);                             %Reynolds Number for bodies
...
body.cf=A./(log10(body.Re_use).^b*(1+c*state.Mach^2)^d); %body turbulent skin friction coefficient;
